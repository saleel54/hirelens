 ...
 */
const generateAIFeedback = async (resumeText, jobRole, jobDescription, programmaticMatchedSkills = [], programmaticMissingSkills = []) => {
    if (!ai) {
 ...
 */
function getFallbackMockData(jobRole, matchedSkills, missingSkills) {
...
const evaluateInterviewResponse = async (question, answer, jobRole) => {
    if (!ai) {
